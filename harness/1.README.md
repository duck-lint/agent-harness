...
```text
agents/ (in necessary global config specific to agent model (i.e. `.copilot/agents/`, `.codex/agents/`, etc.))
  harnessed.agent.md
...
For small one-off work, skip project scaffolding and use a lightweight chat plan. For multi-step, repo-scoped, or architecture-shaping work, create numbered seams for the current user-authorized implementation goal and document in `docs/harness/implementation-projects/active/`.
