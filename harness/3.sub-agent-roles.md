...
Updates repo-local memory: tracker, decisions, verification evidence, known failures, and archive summary. It must preserve scaffold-only caveats and failed behavior probes. It does not edit product code.
